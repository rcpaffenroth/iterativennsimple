...
Generated by `examples/lra_benchmark.py` from `lra_image_mnist_step4/config.yaml`.
...
One seed. Validation and test splits are 100 and 100 rows, so the standard error at the best accuracy here (0.840) is about 0.037.

| model | params | lr | best val acc | test acc | epoch | wall clock | s / epoch (incl. val) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 69,898 | 0.001 | 0.8400 | 0.7400 | 167 | 8 s | 0.0 |
| nn.GRU | 52,746 | 0.001 | 0.8400 | 0.8400 | 121 | 4 s | 0.0 |
| nn.RNN | 18,442 | 0.001 | 0.2200 | 0.2900 | 7 | 3 s | 0.0 |
| S2D dense | 18,314 | 0.001 | 0.7500 | 0.6700 | 198 | 134 s | 0.7 |
| S2D monarch nb=4 | 6,026 | 0.001 | 0.6400 | 0.4900 | 143 | 280 s | 1.4 |
