...
Generated by `examples/lra_benchmark.py` from `lra_image_mnist_step16/config.yaml`.
...
One seed. Validation and test splits are 100 and 100 rows, so the standard error at the best accuracy here (0.830) is about 0.038.

| model | params | lr | best val acc | test acc | epoch | wall clock | s / epoch (incl. val) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 76,042 | 0.001 | 0.8100 | 0.7800 | 106 | 3 s | 0.0 |
| nn.GRU | 57,354 | 0.001 | 0.8300 | 0.7300 | 120 | 9 s | 0.0 |
| nn.RNN | 19,978 | 0.001 | 0.8400 | 0.8300 | 110 | 3 s | 0.0 |
| S2D dense | 19,850 | 0.001 | 0.8200 | 0.7500 | 116 | 35 s | 0.2 |
| S2D monarch nb=4 | 7,562 | 0.001 | 0.7700 | 0.8200 | 114 | 80 s | 0.4 |
