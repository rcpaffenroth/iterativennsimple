...
Generated by `examples/lra_benchmark.py` from `lra_image_mnist_step8/config.yaml`.
...
One seed. Validation and test splits are 100 and 100 rows, so the standard error at the best accuracy here (0.870) is about 0.034.

| model | params | lr | best val acc | test acc | epoch | wall clock | s / epoch (incl. val) |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 71,946 | 0.001 | 0.8300 | 0.7700 | 182 | 4 s | 0.0 |
| nn.GRU | 54,282 | 0.001 | 0.8600 | 0.8700 | 100 | 3 s | 0.0 |
| nn.RNN | 18,954 | 0.001 | 0.7900 | 0.6600 | 157 | 3 s | 0.0 |
| S2D dense | 18,826 | 0.001 | 0.7800 | 0.7200 | 190 | 67 s | 0.3 |
| S2D monarch nb=4 | 6,538 | 0.001 | 0.7300 | 0.6500 | 86 | 151 s | 0.8 |
