...
Generated by `examples/lra_benchmark.py` from `lra_toy_bw_step1/config.yaml`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 67,330 | 0.001 | 1.0000 | 1.0000 | 2 | 1 s | 0.0 |
| nn.GRU | 50,562 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| nn.RNN | 17,026 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| S2D dense | 16,898 | 0.001 | 1.0000 | 1.0000 | 2 | 5 s | 0.3 |
| S2D monarch nb=4 | 4,610 | 0.001 | 1.0000 | 1.0000 | 3 | 10 s | 0.5 |
