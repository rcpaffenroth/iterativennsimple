...
Generated by `examples/lra_benchmark.py` from `lra_toy_bw_step16/config.yaml`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 75,010 | 0.001 | 1.0000 | 1.0000 | 2 | 0 s | 0.0 |
| nn.GRU | 56,322 | 0.001 | 1.0000 | 1.0000 | 2 | 0 s | 0.0 |
| nn.RNN | 18,946 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| S2D dense | 18,818 | 0.001 | 1.0000 | 1.0000 | 2 | 0 s | 0.0 |
| S2D monarch nb=4 | 6,530 | 0.001 | 1.0000 | 1.0000 | 2 | 1 s | 0.0 |
