...
Generated by `examples/lra_benchmark.py` from `lra_toy_bw_step4/config.yaml`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 68,866 | 0.001 | 1.0000 | 1.0000 | 2 | 0 s | 0.0 |
| nn.GRU | 51,714 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| nn.RNN | 17,410 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| S2D dense | 17,282 | 0.001 | 1.0000 | 1.0000 | 2 | 1 s | 0.1 |
| S2D monarch nb=4 | 4,994 | 0.001 | 1.0000 | 1.0000 | 3 | 2 s | 0.1 |
