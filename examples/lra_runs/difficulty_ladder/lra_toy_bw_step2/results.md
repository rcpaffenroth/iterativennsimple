...
Generated by `examples/lra_benchmark.py` from `lra_toy_bw_step2/config.yaml`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.LSTM | 67,842 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| nn.GRU | 50,946 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| nn.RNN | 17,154 | 0.001 | 1.0000 | 1.0000 | 1 | 0 s | 0.0 |
| S2D dense | 17,026 | 0.001 | 1.0000 | 1.0000 | 2 | 2 s | 0.1 |
| S2D monarch nb=4 | 4,738 | 0.001 | 1.0000 | 1.0000 | 2 | 4 s | 0.2 |
