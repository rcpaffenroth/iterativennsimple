...
> detection in the harness; later runs flag such rows automatically and stop early.)
>
...
>   (39x). This is §9.6 of `tasks/OVERVIEW_RNN_SEQUENTIAL_2D.md` confirmed under real
>   training rather than in a microbenchmark, and it is what makes `image_wide_lr`
>   affordable.
>
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| nn.GRU h=128 | 51,594 | 0.2480 | 0.2300 | 20 | 9 s | 0.5 |
| nn.GRU h=512 | 796,170 | 0.3260 | 0.3370 | 20 | 86 s | 4.3 |
| nn.GRU h=2048 | 12,621,834 | 0.1300 | 0.1230 | 5 | 395 s | 19.7 |
| Sequential2DRNN h=128 | 17,930 | 0.1530 | 0.1630 | 18 | 601 s | 30.1 |
| Sequential2DRNN h=512 | 268,298 | 0.1320 | 0.1070 | 17 | 592 s | 29.6 |
| Sequential2DRNN h=2048 | 4,218,890 | 0.1110 | 0.0980 | 5 | 587 s | 29.3 |
| Sequential2DRNN h=512 orth gain=1.0 | 268,298 | 0.1310 | 0.1090 | 17 | 607 s | 30.3 |

### Reading the timings

Spread is 65x between fastest and slowest here. `torch.nn.RNN`/`LSTM`/`GRU` call fused cuDNN kernels covering a whole
